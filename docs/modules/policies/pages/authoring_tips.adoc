...
[TIP]
====
For a review of policy design against a specific use case, https://www.cerbos.dev/workshop?utm_campaign=brand_cerbos&utm_source=documentation&utm_medium=text[book a policy review session with Cerbos].
====
