...
[TIP]
====
For guidance on structuring resource policies for multi-tenant or hierarchical systems, https://www.cerbos.dev/workshop?utm_campaign=brand_cerbos&utm_source=documentation&utm_medium=text[speak to us].
====
