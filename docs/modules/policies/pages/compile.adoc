...
[TIP]
====
https://docs.cerbos.dev/cerbos-hub/[Cerbos Hub] provides private, browser-based, collaborative playgrounds for authoring and testing policies with advanced features like execution traces for debugging condition logic. 
====
