...
[TIP]
====
For a review of production deployment patterns, scaling characteristics, or operational practices, https://www.cerbos.dev/workshop?utm_campaign=brand_cerbos&utm_source=documentation&utm_medium=text[speak to us]. https://docs.cerbos.dev/cerbos-hub/[Cerbos Hub] provides managed policy distribution, audit log aggregation, and PDP monitoring.
====
