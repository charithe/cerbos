...
type Conf struct {
	...
	Credentials cerboshub.CredentialsConf `yaml:"credentials"`
...
func (cc *ConnectionConf) setDefaultsForUnsetFields() {
	if cc.APIEndpoint == "" {
		cc.APIEndpoint = cerboshub.DefaultAPIEndpoint
	}

	if cc.BootstrapEndpoint == "" {
		cc.BootstrapEndpoint = cerboshub.DefaultBootstrapHost
	}
...
func (rc *RemoteSourceConf) validate() error {
	...
	if rc.BundleLabel == "" {
		rc.BundleLabel = cerboshub.GetEnv(cerboshub.BundleLabelKey)
	}
